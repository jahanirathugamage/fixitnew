// // lib/screens/services/ac_screen.dart
...
//       modalSetState(() => _selectedTime = picked);
//     }
//   }
...
//                             GestureDetector(
//                               onTap: () {
//                                 setState(() => _isNowOptionSelected = true);
//                                 modalSetState(
...
//                             GestureDetector(
//                               onTap: () {
//                                 setState(() => _isNowOptionSelected = false);
//                                 modalSetState(
...
//     // Placeholder pricing – update with real values later if needed
//     return 2000;
//   }
...
//                                     final jobId = await _createACJob(
//                                       items: items,
//                                       visitationFee: visitationFee,
//                                       platformFee: platformFee,
//                                     );
...
//                         children: [
//                           _service('Full service', Icons.air),
//                           _service('Gas top-up', Icons.local_gas_station),
//                           _service('Filter cleaning', Icons.water_damage),
//                           _service('Water leak repair', Icons.waves),
//                           _service('Basic repair', Icons.build),
//                           _service(
...
//   Widget _service(String label, IconData icon) {
//     return ServiceOptionCard(
//       icon: icon,
//       label: label,
//       isSelected: _selectedServices.contains(label),
//       onTap: () => _onServiceTapped(label),
//     );
//   }
// }
