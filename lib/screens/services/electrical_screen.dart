// lib/screens/services/electrical_screen.dart
...
class _ElectricalScreenState extends State<ElectricalScreen> {
  ...
  Future<String?> _createElectricalJob({
                          ...
                          child: ElevatedButton(
                            onPressed: isSaving
                                ...
                                : () async {
                                    ...
                                    final jobId = await _createElectricalJob(
                                      items: items,
                                      visitationFee: visitationFee,
                                      platformFee: platformFee,
                                    );
                        ...
                        children: [
                          ServiceOptionCard(
                            ...
                            isSelected: _selectedServices
                                .contains('Light bulb replacement'),
                            onTap: () =>
                                _onServiceTapped('Light bulb replacement'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.light,
                            label: 'Light fixture installation',
                            isSelected: _selectedServices
                                .contains('Light fixture installation'),
                            onTap: () =>
                                _onServiceTapped('Light fixture installation'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.power,
                            label: 'Switch replacement',
                            isSelected: _selectedServices
                                .contains('Switch replacement'),
                            onTap: () =>
                                _onServiceTapped('Switch replacement'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.electrical_services,
                            label: 'Minor Socket Fix',
                            isSelected: _selectedServices
                                .contains('Minor Socket Fix'),
                            onTap: () =>
                                _onServiceTapped('Minor Socket Fix'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.settings_input_composite,
                            label: 'Trip switch troubleshoot',
                            isSelected: _selectedServices
                                .contains('Trip switch troubleshoot'),
                            onTap: () =>
                                _onServiceTapped('Trip switch troubleshoot'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.handyman,
                            label: 'Minor wiring repairs',
                            isSelected: _selectedServices
                                .contains('Minor wiring repairs'),
                            onTap: () =>
                                _onServiceTapped('Minor wiring repairs'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.power_settings_new,
                            label: 'Power outage diagnosis',
                            isSelected: _selectedServices
                                .contains('Power outage diagnosis'),
                            onTap: () =>
                                _onServiceTapped('Power outage diagnosis'),
                          ),
                        ],
                      ),
                      const SizedBox(height: 30),
