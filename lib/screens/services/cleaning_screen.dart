// // lib/screens/services/cleaning_screen.dart
...
//   Future<String?> _createCleaningJob({
...
//                                     final jobId = await _createCleaningJob(
//                                       items: items,
//                                       visitationFee: visitationFee,
//                                       platformFee: platformFee,
//                                     );
...
//                                 .contains('Kitchen deep clean'),
//                             onTap: () =>
//                                 _onServiceTapped('Kitchen deep clean'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.bathtub,
//                             label: 'Bathroom deep clean',
//                             isSelected: _selectedServices
//                                 .contains('Bathroom deep clean'),
//                             onTap: () =>
//                                 _onServiceTapped('Bathroom deep clean'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.weekend,
//                             label: 'Sofa/ cushion cleaning',
//                             isSelected: _selectedServices
//                                 .contains('Sofa/ cushion cleaning'),
//                             onTap: () =>
//                                 _onServiceTapped('Sofa/ cushion cleaning'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.bed,
//                             label: 'Mattress cleaning',
//                             isSelected: _selectedServices
//                                 .contains('Mattress cleaning'),
//                             onTap: () =>
//                                 _onServiceTapped('Mattress cleaning'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.cleaning_services,
//                             label: 'Floor scrubbing & polishing',
//                             isSelected: _selectedServices
//                                 .contains('Floor scrubbing & polishing'),
//                             onTap: () => _onServiceTapped(
...
//                             isSelected: _selectedServices
//                                 .contains('Window & grill cleaning'),
//                             onTap: () =>
//                                 _onServiceTapped('Window & grill cleaning'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.balcony,
//                             label: 'Balcony cleaning',
//                             isSelected: _selectedServices
//                                 .contains('Balcony cleaning'),
//                             onTap: () =>
//                                 _onServiceTapped('Balcony cleaning'),
//                           ),
//                         ],
//                       ),
