// lib/screens/services/gardening_screen.dart
...
class _GardeningScreenState extends State<GardeningScreen> {
  ...
  Future<String?> _createGardeningJob({
  ...
  void _onServiceTapped(String label) {
    setState(() {
      if (_selectedServices.contains(label)) {
        ...
        // Select only if fewer than 3 are currently selected
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              // Inputs are remembered in state, simply close
                              Navigator.of(sheetContext).pop();
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: Colors.black,
                          ...
                          child: ElevatedButton(
                            onPressed: isSaving
                                ...
                                : () async {
                                    ...
                                    final jobId = await _createGardeningJob(
                                      items: items,
                                      visitationFee: visitationFee,
                                      platformFee: platformFee,
                                    );
                        ...
                        children: [
                          ServiceOptionCard(
                            ...
                            isSelected: _selectedServices
                                .contains('Grass cutting'),
                            onTap: () => _onServiceTapped('Grass cutting'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.park,
                            label: 'Hedge trimming',
                            isSelected: _selectedServices
                                .contains('Hedge trimming'),
                            onTap: () => _onServiceTapped('Hedge trimming'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.yard,
                            label: 'Weeding',
                            isSelected: _selectedServices.contains('Weeding'),
                            onTap: () => _onServiceTapped('Weeding'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.recycling,
                            label: 'Compost application',
                            isSelected: _selectedServices
                                .contains('Compost application'),
                            onTap: () =>
                                _onServiceTapped('Compost application'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.account_tree,
                            label: 'Tree branch trimming',
                            isSelected: _selectedServices
                                .contains('Tree branch trimming'),
                            onTap: () =>
                                _onServiceTapped('Tree branch trimming'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.cleaning_services,
                            label: 'Garden cleanup',
                            isSelected: _selectedServices
                                .contains('Garden cleanup'),
                            onTap: () => _onServiceTapped('Garden cleanup'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.local_florist,
                            label: 'Flowerbed arrangement',
                            isSelected: _selectedServices
                                .contains('Flowerbed arrangement'),
                            onTap: () =>
                                _onServiceTapped('Flowerbed arrangement'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.spa,
                            label: 'Potting plants',
                            isSelected:
                                _selectedServices.contains('Potting plants'),
                            onTap: () => _onServiceTapped('Potting plants'),
                          ),
                        ],
                      ),
