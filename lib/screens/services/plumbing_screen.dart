// lib/screens/services/plumbing_screen.dart
...
class _PlumbingScreenState extends State<PlumbingScreen> {
  ...
  Future<String?> _createPlumbingJob({
  ...
  int _getPriceForService(String label) {
    // Placeholder: later map each service to a real price from DB
    return 1500;
  }
                          ...
                          child: ElevatedButton(
                            onPressed: isSaving
                                ...
                                : () async {
                                    ...
                                    final jobId = await _createPlumbingJob(
                                      items: items,
                                      visitationFee: visitationFee,
                                      platformFee: platformFee,
                                    );
                      ...
                      GridView.count(
                        ...
                        children: [
                          ServiceOptionCard(
                            ...
                            label: 'Tap Fix',
                            isSelected:
                                _selectedServices.contains('Tap Fix'),
                            onTap: () => _onServiceTapped('Tap Fix'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.plumbing,
                            label: 'Minor pipe repair',
                            isSelected: _selectedServices
                                .contains('Minor pipe repair'),
                            onTap: () =>
                                _onServiceTapped('Minor pipe repair'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.water_damage,
                            label: 'Pipe sealing',
                            isSelected:
                                _selectedServices.contains('Pipe sealing'),
                            onTap: () => _onServiceTapped('Pipe sealing'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.wc,
                          ...
                          ServiceOptionCard(
                            ...
                            isSelected: _selectedServices
                                .contains('Unclogging drainage'),
                            onTap: () =>
                                _onServiceTapped('Unclogging drainage'),
                          ),
                          ServiceOptionCard(
                            icon: Icons.shower,
                            label: 'Shower head replacement',
                            isSelected: _selectedServices
                                .contains('Shower head replacement'),
                            onTap: () => _onServiceTapped(
                          ...
                          ServiceOptionCard(
                            ...
                            isSelected: _selectedServices
                                .contains('Water filter Installation'),
                            onTap: () => _onServiceTapped(
                          ...
                          ServiceOptionCard(
                            ...
                            isSelected: _selectedServices
                                .contains('Running toilet fix'),
                            onTap: () =>
                                _onServiceTapped('Running toilet fix'),
                          ),
                        ],
                      ),
                      const SizedBox(height: 30),
