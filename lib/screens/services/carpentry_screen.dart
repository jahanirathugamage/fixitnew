// // lib/screens/services/carpentry_screen.dart
...
//   Future<String?> _createCarpentryJob({
...
//                                     final jobId = await _createCarpentryJob(
//                                       items: items,
//                                       visitationFee: visitationFee,
//                                       platformFee: platformFee,
//                                     );
...
//                                 .contains('Door hinge repair'),
//                             onTap: () =>
//                                 _onServiceTapped('Door hinge repair'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.chair,
//                             label: 'Broken chair leg repair',
//                             isSelected: _selectedServices
//                                 .contains('Broken chair leg repair'),
//                             onTap: () =>
//                                 _onServiceTapped('Broken chair leg repair'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.view_sidebar,
//                             label: 'Shelf installation',
//                             isSelected: _selectedServices
//                                 .contains('Shelf installation'),
//                             onTap: () =>
//                                 _onServiceTapped('Shelf installation'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.view_list,
//                             label: 'Shelf repair',
//                             isSelected:
//                                 _selectedServices.contains('Shelf repair'),
//                             onTap: () => _onServiceTapped('Shelf repair'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.settings,
//                             label: 'Handle Replacement',
//                             isSelected: _selectedServices
//                                 .contains('Handle Replacement'),
//                             onTap: () =>
//                                 _onServiceTapped('Handle Replacement'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.table_bar,
//                             label: 'Table leg repair',
//                             isSelected: _selectedServices
//                                 .contains('Table leg repair'),
//                             onTap: () =>
//                                 _onServiceTapped('Table leg repair'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.weekend,
//                             label: 'Assemble furniture',
//                             isSelected: _selectedServices
//                                 .contains('Assemble furniture'),
//                             onTap: () =>
//                                 _onServiceTapped('Assemble furniture'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.inventory_2,
//                             label: 'Drawer repair',
//                             isSelected:
//                                 _selectedServices.contains('Drawer repair'),
//                             onTap: () => _onServiceTapped('Drawer repair'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.construction,
//                             label: 'Patching wood cracks',
//                             isSelected: _selectedServices
//                                 .contains('Patching wood cracks'),
//                             onTap: () =>
//                                 _onServiceTapped('Patching wood cracks'),
//                           ),
//                         ],
//                       ),
