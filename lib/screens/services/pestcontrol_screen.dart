// // lib/screens/services/pest_control_screen.dart
...
//   Future<String?> _createPestControlJob({
...
//                                     final jobId = await _createPestControlJob(
//                                       items: items,
//                                       visitationFee: visitationFee,
//                                       platformFee: platformFee,
//                                     );
...
//                                 .contains('Cockroach treatment'),
//                             onTap: () =>
//                                 _onServiceTapped('Cockroach treatment'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.pest_control,
//                             label: 'Ant control treatment',
//                             isSelected: _selectedServices
//                                 .contains('Ant control treatment'),
//                             onTap: () =>
//                                 _onServiceTapped('Ant control treatment'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.cloud,
//                             label: 'Mosquito fogging',
//                             isSelected: _selectedServices
//                                 .contains('Mosquito fogging'),
//                             onTap: () =>
//                                 _onServiceTapped('Mosquito fogging'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.pest_control_rodent,
//                             label: 'Rodent inspection',
//                             isSelected: _selectedServices
//                                 .contains('Rodent inspection'),
//                             onTap: () =>
//                                 _onServiceTapped('Rodent inspection'),
//                           ),
//                           ServiceOptionCard(
//                             icon: Icons.bug_report_outlined,
//                             label: 'Bed bug treatment',
//                             isSelected: _selectedServices
//                                 .contains('Bed bug treatment'),
//                             onTap: () =>
//                                 _onServiceTapped('Bed bug treatment'),
//                           ),
//                         ],
//                       ),
