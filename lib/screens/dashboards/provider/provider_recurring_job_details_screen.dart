...
class ProviderRecurringJobDetailsScreen extends StatelessWidget {
  final String jobId;
  const ProviderRecurringJobDetailsScreen({super.key, required this.jobId});
    ...
    return Scaffold(
      ...
      body: StreamBuilder<JobRequestModel?>(
        ...
        builder: (context, snap) {
          ...
          final preferredDay =
              (recurrence['preferredDay'] ?? recurrence['day'] ?? '—')
                  .toString()
                  .trim();
          final frequency =
