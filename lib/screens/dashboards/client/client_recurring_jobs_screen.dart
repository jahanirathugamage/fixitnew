// lib/screens/dashboards/client/client_recurring_jobs_screen.dart
...
import 'client_recurring_job_manage_screen.dart';

class ClientRecurringJobsScreen extends StatelessWidget {
  const ClientRecurringJobsScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: StreamBuilder<List<JobRequestModel>>(
          stream: repo.watchByClientUid(user.uid),
                ...
                return InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (_) => ClientRecurringJobManageScreen(jobId: j.id),
                      ),
                    );
                  },
                  child: Container(
