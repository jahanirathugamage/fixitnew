// lib/screens/dashboards/client/client_recurring_job_details_screen.dart
...
class ClientRecurringJobDetailsScreen extends StatelessWidget {
  final String jobId;
  const ClientRecurringJobDetailsScreen({super.key, required this.jobId});
  ...
  String _formatDateTime(Timestamp? ts) {
    ...
    return "$month $day  ·  $hour12.$mm${d.hour >= 12 ? "pm" : "am"}";
  }
  ...
  Widget build(BuildContext context) {
    ...
    final resolver = ClientJobRequestsController();
    ...
    return Scaffold(
      ...
      body: StreamBuilder<JobRequestModel?>(
        ...
        builder: (context, snap) {
          ...
          final preferredDay =
              (recurrence['preferredDay'] ?? '—').toString().trim();
          final frequency =
                  ...
                  children: [
                    ...
                    Expanded(
                      child: FutureBuilder<String>(
                        future: resolver.resolveProviderName(job),
